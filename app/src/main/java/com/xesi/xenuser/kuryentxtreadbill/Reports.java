...
public class Reports extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int billsCount = Integer.parseInt(genericDao.getOneField("COUNT(_id)","armBillHeader","","","","0"));
    ...
    public List<BillHeader> displayRecords() {
        List<BillHeader> billHeaders = billHeaderDAO.getAllBillList("*","","","ORDER BY isUploaded ASC, _id DESC");
        return billHeaders;
    }
