...
public class ArchiveDetailedBill extends BaseActivity {
    ...
    public void btnPrint(View view) {
        msgDialog = new MsgDialog(ArchiveDetailedBill.this);
    ...
    public void onBackPressed() {
        Intent i = new Intent(getApplicationContext(), Archive.class);
        startActivity(i);
        finish();
    }
}